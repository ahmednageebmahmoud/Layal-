...
namespace BLL.BLL
{
    public class PhotoOrdersBll : BasicBLL
    {
        public object Add(PhotoOrderVM o)
        {
        ...
        {
            var Result = db.Phot_Orders_SelectByFilter(skip, take, this.UserLoggad.Id).Select(c => new PhotoOrderVM
            {
                Id = c.Id,
